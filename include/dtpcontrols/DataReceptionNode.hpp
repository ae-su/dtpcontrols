 ...
 *
 * DataReceptionNode is a class derived from uhal::Node.
...
#ifndef DTP_INCLUDE_DTP_DATARECEPTIONNODE_HPP_
#define DTP_INCLUDE_DTP_DATARECEPTIONNODE_HPP_


#include "DTP.hpp"

class DataReceptionNode : public DTP{
